...
func (r *PaymentController) UpdatePaymentTemplate(w http.ResponseWriter, req *http.Request) {
	var userID int
	var template PaymentTemplateUpdate
	var templateID int
	var body []byte
	var err error
	userID, _ = oauth.GetUserId(req)
...
func (r *PaymentController) CreatePaymentTemplate(w http.ResponseWriter, req *http.Request) {
	var userID int
	var templateID int
	var template PaymentTemplateCreate
	var err error
	var body []byte
	userID, _ = oauth.GetUserId(req)
...
func (r *PaymentController) Init(mux *http.ServeMux) {
	...
	mux.Handle("/api/v1/payments", oauth.AuthMiddleware(r.PaymentService.PaymentProvider.Db, r.CookieNameToken, true)(http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		switch req.Method {
		case "POST":
	...
	mux.Handle("/api/v1/payments/{ID}", oauth.AuthMiddleware(r.PaymentService.PaymentProvider.Db, r.CookieNameToken, true)(http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		switch req.Method {
		case "PATCH":
	...
	mux.Handle("/api/v1/payment_templates", oauth.AuthMiddleware(r.PaymentService.PaymentProvider.Db, r.CookieNameToken, true)(http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		switch req.Method {
		case "POST":
	...
	mux.Handle("/api/v1/payment_templates/{ID}", oauth.AuthMiddleware(r.PaymentService.PaymentProvider.Db, r.CookieNameToken, true)(http.HandlerFunc(func(w http.ResponseWriter, req *http.Request) {
		switch req.Method {
		case "PATCH":
