...
func (r *PaymentProvider) UpdatePayment(payment PaymentUpdate, paymentID int, userID int) error {
	var err error
...
func (r *PaymentProvider) CreatePayment(payment PaymentCreate, userID int) (int, error) {
	var paymentID int
...
func (r *PaymentProvider) UpdatePaymentTemplate(template PaymentTemplateUpdate, templateID int, userID int) error {
	var err error
...
func (r *PaymentProvider) CreatePaymentTemplate(template PaymentTemplateCreate, userID int) (int, error) {
	var templateID int
