...
func (r *PaymentService) UpdatePayment(payment PaymentUpdate, paymentID int, userID int) error {
	return r.PaymentProvider.UpdatePayment(payment, paymentID, userID)

}
func (r *PaymentService) CreatePayment(payment PaymentCreate, userID int) (int, error) {
...
func (r *PaymentService) UpdatePaymentTemplate(template PaymentTemplateUpdate, templateID int, userID int) error {
	return r.PaymentProvider.UpdatePaymentTemplate(template, templateID, userID)

}
func (r *PaymentService) CreatePaymentTemplate(template PaymentTemplateCreate, userID int) (int, error) {
