...
func (r *ReceiptProvider) UpdateReceipt(receipt ReceiptUpdateDto, receiptID int, userID int) error {
	var err error
...
func (r *ReceiptProvider) CreateReceipt(receipt ReceiptCreateDto, userID int) (int, error) {
	var receiptID int
...
func (r *ReceiptProvider) UpdateReceiptTemplate(template ReceiptTemplateUpdateDto, templateID int, userID int) error {
	var err error
...
func (r *ReceiptProvider) CreateReceiptTemplate(template ReceiptTemplateCreateDto, userID int) (int, error) {
	var templateID int
